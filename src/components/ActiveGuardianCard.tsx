      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between mb-1">
            ...
            <Badge variant="outline" className="text-gray-800 border-[#2563A8] bg-[#E8F1FC] text-[14px]">
          ...
          <div className="flex items-center space-x-3 mt-3 text-xs">
            {guardian.canViewHistory && (
              <span className="flex items-center text-gray-800 bg-[#E8F1FC] px-2 py-1 rounded-full text-[14px]">
                <Eye size={12} className="mr-1" />
                {language === 'ko' ? '기록 확인' : 'View history'}
              </span>
            )}
            {guardian.canGetNotifications && (
              <span className="flex items-center text-gray-800 bg-[#F6F5F2] px-2 py-1 rounded-full text-[14px]">
