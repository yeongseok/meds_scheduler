  ...
  return (
    <>
      ...
      <div className="p-4 flex-shrink-0">
        <div className="bg-white border-3 border-[#3674B5] rounded-3xl shadow-lg text-gray-700 relative overflow-hidden px-5 py-4">
          {/* Info Banner (for Care Circle page) */}
          {showInfoBanner && (
            <div className="mb-3 bg-white/40 backdrop-blur-sm rounded-2xl p-3 border border-gray-300/30">
              <div className="flex items-start gap-2">
                <HelpCircle size={20} className="text-gray-700 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-semibold text-gray-800 mb-1 text-[16px]">
          ...
          {!showInfoBanner && (
            <div className="flex items-center justify-between mb-3">
              <div>
                <p className="text-gray-700 text-[16px] font-bold">{t('home.date')}</p>
              </div>
              {onNavigateToSettings && (
                <Button 
                  variant="ghost" 
                  size="icon" 
                  className="h-11 w-11 bg-white/40 hover:bg-white/60 border-0 rounded-full"
                  onClick={onNavigateToSettings}
                >
                  <Settings className="text-gray-700 size-7" strokeWidth={2.5} />
                </Button>
              )}
            </div>
          )}
          ...
          <div className="flex items-center gap-3 overflow-x-auto">
              ...
              >
                <div className={`relative mb-1.5 transition-all duration-200 rounded-full bg-white p-1 ${
                  ...
                  <Avatar className="w-12 h-12">
                    <AvatarFallback className="bg-[#F0EBE3] text-gray-700 text-[14px]">
                      ME
                    </AvatarFallback>
                  </Avatar>
                  {(selectedView === 'my-meds' || selectedView === 'my-history') && (
                    <motion.div 
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      className="absolute -bottom-0.5 -right-0.5 w-5 h-5 bg-[#2563A8] rounded-full border-2 border-white flex items-center justify-center shadow-sm"
                    >
                      <CheckCircle size={12} className="text-white" />
                    </motion.div>
                  )}
                </div>
                <span className={`text-[16px] transition-all duration-200 ${
                  selectedView === 'my-meds' || selectedView === 'my-history'
                    ? 'text-gray-800' 
            ...
            {careRecipients.map((person) => (
              ...
              >
                ...
                <span className={`text-[16px] transition-all duration-200 max-w-[56px] text-center truncate ${
                  selectedView === person.id 
                    ? 'text-gray-800' 
                    : 'text-gray-600 group-hover:text-gray-800'
                }`}>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <div className="relative mb-1.5 w-14 h-14 rounded-full bg-white/40 border-2 border-dashed border-gray-300/50 group-hover:border-gray-400/70 flex items-center justify-center transition-all duration-200 group-hover:bg-white/60">
                <Plus className="text-gray-700" size={22} />
              </div>
              <span className="text-[16px] text-gray-600 group-hover:text-gray-800 transition-all duration-200">
                {language === 'ko' ? '+ 추가' : '+ Add'}
              </span>
            </motion.button>
          </div>
        ...
        <DialogContent className="max-w-md rounded-3xl">
          ...
          <div className="flex gap-2 mt-4">
            ...
            <Button
              ...
              className="flex-1 bg-[#3674B5] hover:bg-[#2563A8] text-white text-[16px]"
            >
        ...
        <DialogContent className="max-w-md rounded-3xl">
          ...
          <div className="text-center space-y-4 py-4">
            ...
            <div className="flex justify-center">
              <div className="w-20 h-20 rounded-full bg-[#3674B5] flex items-center justify-center shadow-lg">
            ...
            {/* Features List */}
            <div className="space-y-3 text-left bg-[#F6F5F2] rounded-xl p-4">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[#3674B5] flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            {/* Pricing */}
            <div className="bg-white rounded-xl p-4 border-2 border-[#3674B5]">
              ...
              <p className="text-[14px] text-[#2563A8] font-semibold mt-1">
            ...
            <div className="space-y-2 pt-2">
              <Button
                ...
                className="w-full h-14 bg-[#3674B5] hover:bg-[#2563A8] text-white shadow-lg text-[18px] font-semibold"
              >
