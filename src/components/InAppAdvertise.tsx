  ...
  return (
    <Card className="mx-2 mb-2 bg-white border-gray-200 shadow-sm">
      ...
      <div className="p-2 flex items-center gap-2">
        {/* Ad Image */}
        <div className="w-14 h-14 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
          <div className="text-blue-600 text-[18px] font-bold">건강+</div>
        </div>
